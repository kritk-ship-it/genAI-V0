...
export const generateInitialImage = async (prompt: string): Promise<ImageData> => {
  ...
  if (!response.generatedImages?.[0]?.image?.imageBytes) {
      throw new Error("Image generation failed. This could be due to safety filters or an API issue.");
  }
...
export const editImage = async (prompt: string, image: ImageData): Promise<ImageData> => {
  ...
  throw new Error("No image was generated by the edit request. This could be due to safety filters.");
};
